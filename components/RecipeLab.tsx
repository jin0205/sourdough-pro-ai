    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-stone-800 dark:text-stone-100">Recipe Lab</h2>
                    <p className="text-stone-600 dark:text-stone-400">Advanced AI tools for recipe development and science.</p>
                </div>
                <div className="bg-stone-200 dark:bg-stone-800 p-1 rounded-lg inline-flex whitespace-nowrap transition-colors">
                    <button
            ...
            {mode === 'developer' ? (
                <div className="animate-fade-in">
                     <p className="text-stone-600 dark:text-stone-400 mb-6">Challenge the AI with your most complex baking ideas. Leverage maximum "thinking" power to develop novel recipes, optimize production schedules, or formulate a business plan.</p>
                    <form onSubmit={handleDeveloperSubmit} className="flex gap-4 mb-6">
                        <input
                            ...
                            className="flex-grow block w-full px-3 py-2 bg-white dark:bg-stone-950 border border-stone-300 dark:border-stone-700 rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm dark:text-stone-100"
                            disabled={isLoading}
                        />
                        <button
                            type="submit"
                ...
                <div className="animate-fade-in">
                    <p className="text-stone-600 dark:text-stone-400 mb-6">Model your fermentation kinetics. Input your environmental variables to predict fermentation time and optimal shaping windows.</p>
                    <form onSubmit={handleFermentationSubmit} className="bg-white dark:bg-stone-900 p-6 rounded-lg border border-stone-200 dark:border-stone-800 shadow-sm mb-6 transition-colors">
            ...
            <div className="bg-stone-900 dark:bg-stone-950 text-stone-100 p-6 rounded-lg font-mono text-sm min-h-[200px] whitespace-pre-wrap overflow-x-auto shadow-inner transition-colors">
                {isLoading && (
                    <div className="flex items-center justify-center h-full py-12">
                        <div className="text-center">
                            <Spinner />
                            <p className="mt-2 text-stone-300 dark:text-stone-500">
                                {mode === 'developer' 
                ...
                {!isLoading && !response && (
                    <div className="text-stone-500 dark:text-stone-600 text-center py-12 italic">
                        {mode === 'developer' 
